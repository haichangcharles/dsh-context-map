...
export const ContextMessageAction = memo(function ContextMessageAction({
  seq, useContextify, setNodeMode, locate, moveBranchSuggestion,
  ...
  return <>
    <span className={css.root} aria-label={`Context for ${node.preview}`}>
    ...
    {suggestion !== undefined && suggestion.output.seq === seq && dismissedSuggestionId !== suggestion.id
