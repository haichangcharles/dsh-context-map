...
function MessageItem({ node, t: translate, referenceLabels, skillNames }: MessageItemProps) {
  ...
  switch (node.kind) {
    case 'user':
      return <UserMessageNodeView {...props as ChatNodeViewProps<'user'>} renderSlot={() => null} />
    case 'steering':
      return <UserMessageNodeView {...props as ChatNodeViewProps<'steering'>} renderSlot={() => null} />
    case 'context':
