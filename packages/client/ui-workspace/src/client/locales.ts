...
export const zh = {
  ...
  'session.branch.expand': '展开“{name}”的分支',
  'session.branch.collapse': '收起“{name}”的分支',
  'empty.none': '暂无会话',
  ...
  'archive.open': '查看已归档会话（{n}）',
  'archive.title': '已归档会话',
  'archive.back': '返回会话列表',
  'archive.search.aria': '搜索已归档会话',
  'archive.search.placeholder': '搜索已归档会话…',
  'archive.list.aria': '已归档会话',
  'archive.restore': '恢复',
  'archive.restoring': '恢复中…',
  'archive.restore.aria': '恢复“{name}”',
  'archive.branchOf': '分支自“{name}”',
  'archive.empty': '暂无已归档会话',
  'archive.noMatches': '无匹配的已归档会话',
...
export const en = {
  ...
  'session.branch.expand': 'Expand branches under {name}',
  'session.branch.collapse': 'Collapse branches under {name}',
  ...
  'archive.open': 'View archived sessions ({n})',
  'archive.title': 'Archived sessions',
  'archive.back': 'Back to sessions',
  'archive.search.aria': 'Search archived sessions',
  'archive.search.placeholder': 'Search archived sessions…',
  'archive.list.aria': 'Archived sessions',
  'archive.restore': 'Restore',
  'archive.restoring': 'Restoring…',
  'archive.restore.aria': 'Restore “{name}”',
  'archive.branchOf': 'Branched from “{name}”',
  'archive.empty': 'No archived sessions',
  'archive.noMatches': 'No matching archived sessions',
