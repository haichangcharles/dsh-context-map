...
- **没有 Session 删除**：归档／恢复是非破坏性能力；永久删除 Session 或其日志属于另一项尚未提供的能力，删除 Workspace 注册记录也不能替代它。
