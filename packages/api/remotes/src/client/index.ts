...
import contextifyRemote from '@deepseek-ai/dsh-contextify/remote'
...
export type {} from '@deepseek-ai/dsh-contextify/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      contextifyRemote, agentPresetsRemote, commandsRemote, settingsControllerRemote, goalsRemote, llmRemote, dynamicRemote,
