  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        parameters: [{ name: 'opts', description: 'source session id, either an inclusive atSeq anchor or an exclusive beforeSeq turn-start anchor, and whether to increment an inherited durable title before resolving.' }],
