...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-ui-contextify ContextMessageAction id \'contextify\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-contextify BranchSuggestionTail',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Action strip attached to one durable user or admitted steering message.',
    doc: 'Action strip attached to one durable user or admitted steering message.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'A feature-owned native Inspector rendered on the Details subpage.',
    doc: 'A feature-owned native Inspector rendered on the Details subpage.\nThe provider owns selection and presentation; the conversation shell\nonly supplies the stable right-column page host.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    occupants: [
      'client-ui-trajectory TrajectoryInspectorSeat',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'conversation.details.pinned',
    kind: 'list',
    scope: 'session',
    summary: 'Additive, always-visible content in the conversation details column.',
    doc: 'Additive, always-visible content in the conversation details column.\nEntries share the column with the transient Tool drawer instead of\nreplacing it; each entry owns its own header and close affordance.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'details\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-contextify ContextMapPanel id \'contextify\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.details.pinned\', () => ctx.slots.register(\n      { name: \'conversation.details.pinned\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-conversation/src/client/contract/slots.ts:81',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-contextify ContextifyPromptSettingsSection id \'contextify-prompts\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-contextify DetailsOpener id \'contextify-open-details\'',
    ],
    replaceRisk: 'none',
