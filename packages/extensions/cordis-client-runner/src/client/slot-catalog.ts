...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: context-map',
    ...
    occupants: [
      'client-ui-contextify ContextMapPanel key \'context-map\'',
