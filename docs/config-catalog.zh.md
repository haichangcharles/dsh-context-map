...
- `@deepseek-ai/dsh-contextify`——依赖 `agents` · `sessions` · `sessionPersistence` · `contextCompiler`（[`packages/context/contextify/src/index.ts`](../packages/context/contextify/src/index.ts)）
