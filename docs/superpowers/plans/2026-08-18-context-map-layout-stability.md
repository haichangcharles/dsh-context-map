...
- [x] **Step 1: Add a React Flow test seam**
...
- [x] **Step 2: Add the viewport regression test**
...
- [x] **Step 3: Add the Re-layout behavior test**
...
- [x] **Step 2: Keep explicit node focus identity-driven**
...
- [x] **Step 1: Write one future-work list**
...
- [x] **Step 2: Update package behavior documentation**
