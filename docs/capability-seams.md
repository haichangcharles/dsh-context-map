...
| `ctx.contextify` | `core` | [`contextify`](../packages/context/contextify) | - | [`api-remotes`](../packages/api/remotes) | [`context-compiler`](../packages/context/context-compiler), `ui-contextify` | Projects native Session families, commits revisioned context plans, and registers the contextify@3 compiler used by the next admitted model request. |
