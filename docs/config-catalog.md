...
- `@deepseek-ai/dsh-contextify` — requires `agents` · `sessions` · `sessionPersistence` · `contextCompiler` · `llm` ([`packages/context/contextify/src/index.ts`](../packages/context/contextify/src/index.ts))
