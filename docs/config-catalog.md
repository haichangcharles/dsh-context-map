...
- `@deepseek-ai/dsh-contextify` — requires `agents` · `sessions` · `sessionPersistence` · `contextCompiler` ([`packages/context/contextify/src/index.ts`](../packages/context/contextify/src/index.ts))
