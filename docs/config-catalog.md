...
- `@deepseek-ai/dsh-contextify` — requires `agents` · `sessions` · `sessionPersistence` · `contextCompiler` · `subagents` ([`packages/context/contextify/src/index.ts`](../packages/context/contextify/src/index.ts))
