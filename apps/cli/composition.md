...
flowchart LR
  ...
  plugin_dsh_base_context_compiler["context-compiler<br/>@deepseek-ai/dsh-context-compiler"]
  cfg --> plugin_dsh_base_context_compiler
...
| `context-compiler` | `@deepseek-ai/dsh-context-compiler` |
