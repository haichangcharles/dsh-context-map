...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-contextify': { kind: 'indirect', reason: 'Browser controls delegate durable context-plan changes and compilation to the Contextify Host plugin.' },
