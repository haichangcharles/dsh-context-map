...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-contextify': { kind: 'indirect', reason: 'Browser controls mutate the host-owned Contextify plan; the selected context compiler owns the resulting model request.' },
