...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ContextBranchRelocationPreparation: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextBranchRelocationResult: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextCompilation: 'Context Map contract is owned by packages/context/context-compiler/src/index.ts',
  ContextCompileRequest: 'Context Map contract is owned by packages/context/context-compiler/src/index.ts',
  ContextCompilerDefinition: 'Context Map contract is owned by packages/context/context-compiler/src/index.ts',
  ContextCompilerDescriptor: 'Context Map contract is owned by packages/context/context-compiler/src/index.ts',
  ContextFamilyGraphPage: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextMessageRef: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextNodeMutation: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextPlanRef: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextRecommendationBase: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextRecommendationMode: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextRecommendationProposal: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
  ContextifyView: 'Context Map contract is owned by packages/context/contextify/src/types.ts',
